...
This version of morpho is now archived, only the README will be updated. Newer versions of crates have since come out that result in different needs. Rather than updating this one, it is being preserved for reference.

See [kiabluejay](https://github.com/jpegleg/kiabluejay/) for an example instead.
